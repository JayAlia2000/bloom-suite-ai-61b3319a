  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "gradient-glass border-primary/10 backdrop-blur-md",
        soft: "bg-secondary/30 border-transparent",
        feature: "gradient-card border-primary/10 shadow-soft hover:shadow-glow hover:scale-[1.02]",
      },
    },
    defaultVariants: {
      variant: "default",
